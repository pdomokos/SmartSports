class GoogleSynchronizer < SynchronizerBase
  require "net/https"
  require "uri"
  ...
  def sync_data(jsonarr, startTime)
    ...
    remove_summary_not_final('google')
  ...
  def get_last_synced_not_final_date(source)
  ...
  def query_steps()
    start_time = get_last_synced_not_final_date('google')
