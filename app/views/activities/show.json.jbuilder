json.extract! @activity, :id, :user_id, :source, :activity, :group, :game_id, :start_time, :end_time, :steps, :duration, :distance, :calories, :manual, :intensity, :created_at, :updated_at, :favourite, :activity_type_id
