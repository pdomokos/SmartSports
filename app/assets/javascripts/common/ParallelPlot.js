function ParallelPlot(chartElement, data, yLabel) {
    ...
    this.getMap = function (data, colors) {
    ...
    this.draw = function (rangeA, rangeB) {
        self = this;
        colorMap = this.getMap(this.chartData);
        parDataA = {};
        parDataB = {};
        dotData = [];
        ...
        //console.log(arr);
        time_extent = d3.extent(arr, function (d) {
        ...
        bg_extent = d3.extent(this.chartData, function (d) {
            return d.value
        });
        ...
        bgline = d3.svg.line()
            .x(function (d) {
                return (time_scale(moment(d.date).toDate()))
            })
            .y(function (d) {
                return (scale_left(d.value))
            });
